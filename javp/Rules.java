    ...
    Rules(String name) {
        ...
        rules.setText(
                "<html>" +
                        ...
                        +
                        "4. The testing room must be well-lit and you must be clearly visible" + "<br><br>" +
                        ...
                        "8. May you know more than what Prince Kumar knows, Good Luck" + "<br><br>" +
                        "<html>");
        add(rules);
        ...
        start.setBackground(new Color(149, 212, 122));
